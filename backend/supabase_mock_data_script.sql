...
-- ============================================================================
INSERT INTO nodes (
    id, board_id, x, y, width, height, title, prompt, response, role,
    ...
    (
        ...
        150.0,
        'Initial Idea',
        'We want to build a new AI-powered note-taking app',  -- CHANGED: was content
        NULL,  -- NEW: response will be generated by LLM
        'user',
        TRUE,
        FALSE,
        TRUE,
    ...
    (
        ...
        150.0,
        'Features',
        'Key features: voice notes, auto-summarization, smart tags',  -- CHANGED: was content
        NULL,  -- NEW
        'assistant',
        FALSE,
        FALSE,
    ...
    (
        ...
        150.0,
        'Target Users',
        'Primary users: students, researchers, knowledge workers',  -- CHANGED: was content
        NULL,  -- NEW
        'assistant',
        FALSE,
        FALSE,
    ...
    (
        ...
        150.0,
        'Tech Stack',
        'React + FastAPI + Supabase + Gemini API',  -- CHANGED: was content
        NULL,  -- NEW
        'user',
        FALSE,
        FALSE,
    ...
    (
        ...
        150.0,
        'MVP Timeline',
        'Phase 1: Core note-taking (4 weeks), Phase 2: AI features (6 weeks)',  -- CHANGED: was content
        NULL,  -- NEW
        'assistant',
        FALSE,
        FALSE,
